...
export function polygonHachureLines(polygon, hachureGap, hachureAngle) {
    ...
    const lines = straightHachureLines(polygon, gap);
    if (angle) {
        rotatePoints(polygon, rotationCenter, -angle);
...
function straightHachureLines(polygon, gap) {
    const vertexArray = [];
