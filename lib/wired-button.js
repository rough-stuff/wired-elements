...
import { LitElement, customElement, property, query, css, html } from 'lit-element';
import { rectangle, line } from './core';
let WiredButton = class WiredButton extends LitElement {
    constructor() {
        super(...arguments);
        this.elevation = 1;
        this.disabled = false;
...
], WiredButton.prototype, "svg", void 0);
__decorate([
    query('button'),
